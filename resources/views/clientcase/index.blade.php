                        ...
                        <tbody>
                            ...
                            @foreach ($clientcases as $clientcase)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($clientcase->start_time)->format('h:i A') }}</td>
                                    <td>{{ \Carbon\Carbon::parse($clientcase->end_time)->format('h:i A') }}</td>
                                    ...
                                    <td class="d-flex gap-1">
                                        ...
                                        <a href="{{ route('cases.show', $clientcase->id) }}"
