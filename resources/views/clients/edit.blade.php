    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0">Client Edit</h5>
            </div><!-- end card header -->
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="num" name="phone" value="{{ $client->phone }}" class="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="gst_number" value="{{ $client->gst_number }}"
